...
<img :src="withBase('/media/dashboard.gif')" alt="Local TokenOps dashboard: 5 KPI tiles incl. CACHE HIT, daily cost over time, hourly tokens-per-bucket. Captured live against v0.17 cycling through 1h → 6h → 24h → 7d filters." style="width:100%;max-width:960px;display:block;margin:24px auto;border-radius:8px;border:1px solid var(--vp-c-divider);" loading="eager" />
