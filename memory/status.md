...
## Next Session Should
Snapshot-vs-baseline is RESOLVED (verified-row pinning, #151). Released as **v0.41.0**. Fast-follow candidates: **pricing show/diff pin-awareness** (they render the raw snapshot, so
